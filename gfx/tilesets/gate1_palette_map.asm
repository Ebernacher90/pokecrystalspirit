	tilepal 0, GRAY, GRAY, WATER, WATER, RED, YELLOW, YELLOW, GREEN
	tilepal 0, GREEN, GREEN, GRAY, GRAY, GRAY, GRAY, BROWN, BROWN
	tilepal 0, WATER, GRAY, WATER, WATER, RED, YELLOW, YELLOW, GREEN
	tilepal 0, GREEN, GREEN, GRAY, GRAY, GRAY, GRAY, BROWN, WATER
	tilepal 0, GREEN, GREEN, GRAY, GRAY, GREEN, BROWN, BROWN, WATER
	tilepal 0, RED, RED, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN
	tilepal 0, GREEN, GREEN, GREEN, GREEN, GRAY, BROWN, BROWN, WATER
