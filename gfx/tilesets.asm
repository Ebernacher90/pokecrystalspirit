...
TilesetUnderground1GFX:
INCBIN "gfx/tilesets/underground1.2bpp.lz"

TilesetUnderground1Meta:
INCBIN "data/tilesets/underground1_metatiles.bin"

TilesetUnderground1Coll:
INCLUDE "data/tilesets/underground1_collision.asm"

TilesetGate1GFX:
INCBIN "gfx/tilesets/gate1.2bpp.lz"

TilesetGate1Meta:
INCBIN "data/tilesets/gate1_metatiles.bin"

TilesetGate1Coll:
INCLUDE "data/tilesets/gate1_collision.asm"

TilesetMoblinsCaveGFX:
INCBIN "gfx/tilesets/moblins_cave.2bpp.lz"

TilesetMoblinsCaveMeta:
INCBIN "data/tilesets/moblins_cave_metatiles.bin"

TilesetMoblinsCaveColl:
INCLUDE "data/tilesets/moblins_cave_collision.asm"
