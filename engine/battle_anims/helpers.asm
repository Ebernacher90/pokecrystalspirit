...
endr
	jr .loop
.done
	; switch to the WRAM bank of wOBPals 2 so we can write tom it
	ld a, BANK(wOBPals2)
	ld [rSVBK], a
	; load the RGB colors into the middle two coloors of PAL_BATTLE_OB_RED
...
endr
	...
	pop af
	ld [rSVBK], a
	; restore the grafics index to be loaded
