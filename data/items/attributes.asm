...
; KINGS_ROCK
	item_attribute 100, HELD_FLINCH, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; BITTER_BERRY
...
; ITEM_8E
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_COAT
	item_attribute 100, HELD_STEEL_BOOST, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; DRAGON_FANG
