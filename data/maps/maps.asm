...
MapGroup_Dungeons:
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, ROUTE, FUCHSIA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneBeta, TILESET_PARK, ROUTE, FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cerulean:
    ...
    map PowerPlant1F, TILESET_FACILITY, INDOOR, POWER_PLANT, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PowerPlant2F, TILESET_FACILITY, INDOOR, POWER_PLANT, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
    map CeruleanCave1F, TILESET_CAVE, CAVE, ROUTE_4, MUSIC_DARK_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
    map CeruleanCave2F, TILESET_DARK_CAVE, CAVE, ROUTE_4, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map UndergroundPathRoute7, TILESET_GATE1, GATE, ROUTE_7, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map UndergroundPathWestEast, TILESET_UNDERGROUND1, INDOOR, ROUTE_7, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
    ...
    map OlivineCave1F, TILESET_CAVE, CAVE, ROUTE_40, MUSIC_SEVENNATIONARMY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
    map OlivineCaveB1F, TILESET_CAVE, CAVE, ROUTE_40, MUSIC_SEVENNATIONARMY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MoblinsHideout, TILESET_MOBLINS_CAVE, CAVE, ROUTE_40, MUSIC_SEVENNATIONARMY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
    map FantasticIdyll, TILESET_JOHTO, ROUTE, ROUTE_40, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
